...
public enum Token
{
    ...
    MP_ASSIGN, MP_COLOR, MP_COMMA, MP_EQUAL, MP_FLOAT_DIVIDE, MP_GEQUAL, MP_GTHAN, MP_LEQUAL, MP_LPAREN,
    MP_LTHAN, MP_MINUS, MP_NEQUAL, MP_PERIOD, MP_PLUS, MP_RPAREN, MP_SCOLOR, MP_TIMES, MP_EOF, MP_RUN_COMMENT,
